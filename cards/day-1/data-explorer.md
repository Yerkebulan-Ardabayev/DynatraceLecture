...
- «Где смотреть расход лицензии без customer portal?» Ответ: в семействе `builtin:billing.*` (Host Units, DDU, User Sessions) прямо в собственном окружении, связи наружу не нужно.
