...
Лекторский сценарий: workshop/day-2.md, блоки [0:25-0:50] «Главное демо курса: от карточки проблемы до метода в коде» и [1:15-1:35] «Инструменты одного сервиса и чтение трассировки». <!-- qc:ignore=CARD_UNSOURCED_NUMBER -->
