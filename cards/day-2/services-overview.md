...
Тумблер Service Detection v2 серый: проговариваю, что v2 включают планово, сначала на не-prod хостах, потом на prod, потому что названия Service могут поменяться и это заденет Alerting profiles и Dashboards.
