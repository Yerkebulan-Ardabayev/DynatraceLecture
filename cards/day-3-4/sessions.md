...
Лекторский сценарий: workshop/day-3.md, блок [0:40-1:00] «Сессии: провал, водопад, «в один клик», Session Replay» и workshop/day-4.md, блок [0:40-1:10] «Кейс «заявка пользователя»: от жалобы maria до SQL». <!-- qc:ignore=CARD_UNSOURCED_NUMBER -->
