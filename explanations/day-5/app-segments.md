...
Второй инструмент сегментации: **Management zones** (разбирали в Дне 1, Тема 14 «Зоны управления»). MZ: view на все сущности (apps + services + hosts), принадлежащие одной логической единице.
