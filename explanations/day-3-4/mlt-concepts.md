...
- ЕСЛИ инцидент старше 35 дней → ТО лог-строки по нему уже удалены (Logs Classic держит 35 дней фиксировано), расследовать придётся по метрикам и Davis-событиям, не по логам.
