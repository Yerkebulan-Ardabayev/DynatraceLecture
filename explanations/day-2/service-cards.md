...
На демо-тенанте видно **239 Services**. Эта страница используется как точка входа в детальный анализ: клик по имени сервиса открывает его карточку, где и происходит вся работа, описанная в этой теме.
