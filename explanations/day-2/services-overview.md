...
На captured тенанте в момент сбора видно **239 Services**. Это количество слегка меняется во времени (на день раньше было 244), что нормально: сервисы появляются при новых деплойментах и исчезают при удалениях.
